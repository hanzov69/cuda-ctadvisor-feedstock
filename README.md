About cuda-ctadvisor-feedstock
==============================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/cuda-ctadvisor-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cuda-ctadvisor-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add cuda-ctadvisor
# for installing globally
pixi global install cuda-ctadvisor
```
...
It is possible to list all of the versions of `cuda-ctadvisor` available on your platform:
...
```
pixi search cuda-ctadvisor --channel conda-forge
```
